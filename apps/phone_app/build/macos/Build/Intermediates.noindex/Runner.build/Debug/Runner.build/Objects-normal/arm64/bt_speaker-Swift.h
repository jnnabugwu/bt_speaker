...
#ifndef BT_SPEAKER_SWIFT_H
#define BT_SPEAKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="bt_speaker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC10bt_speaker11AppDelegate")
...
SWIFT_CLASS("_TtC10bt_speaker17MainFlutterWindow")
